 ...
 * @return MEBWindow* 
 */
MEBWindow *Window(int x, int y, int cols, int rows, char* title)
{
    ...
    // // Draw the title.
    // mvwprintw(w->win, 0, 2, " %s ", title);

    // // Draw the window size.
    // mvwprintw(w->win, rows - 1, cols - 10, " %dx%d ", cols, rows);
...
/**
 * @brief Frees window memory; to be called by end-user at end of window use.
 * 
 * @param w The window.
 */
